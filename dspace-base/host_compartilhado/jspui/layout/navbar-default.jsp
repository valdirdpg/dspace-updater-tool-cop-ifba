...
%>
       ...
       <div class="navbar-header">
         ...
         <a class="navbar-brand" href="<%= request.getContextPath() %>/"><img height="25" src="<%= request.getContextPath() %>/image/dspace-logo-only.png" alt="IFBA logo" /></a>
       </div>
       <nav class="collapse navbar-collapse bs-navbar-collapse" role="navigation">
        ...
        <li class="dropdown-header"><fmt:message key="jsp.layout.navbar-default.browseitemsby"/></li>
          ...
          <li class="<%= ( currentPage.endsWith( "/orientacoes" ) ? "active" : "" ) %>"><dspace:popup page="<%= LocaleSupport.getLocalizedMessage(pageContext, \"orientacoes.index\") %>"><fmt:message key="jsp.layout.navbar-default.orientacoes"/></dspace:popup></li>
