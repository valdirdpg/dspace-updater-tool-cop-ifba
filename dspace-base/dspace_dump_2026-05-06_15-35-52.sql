...
--
-- Name: dspace; Type: DATABASE; Schema: -; Owner: -
--

CREATE DATABASE dspace WITH TEMPLATE = template0 ENCODING = 'UTF8' LOCALE = 'en_US.utf8';
...
--
-- Name: dspace; Type: DATABASE PROPERTIES; Schema: -; Owner: -
--
